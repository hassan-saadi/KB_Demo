...
for index, row in graph_df.iterrows():
    html = '<thead><tr><th>Item</th><th>Data</th></tr></thead><tbody><tr><td>Topics</td><td>'+row['TOPICS'] +"</td></tr><tr><td>Events</td><td>"
    row['IEVENTS']+ "</td></tr><tr><td>URL</td><td>" + row['URL'] + "</td></tr><tr><td>Node Distance</td><td>"+row['NODE_DISTANCE']+"</td></tr></tbody></table>"
