...
for index, row in graph_df.iterrows():
    ...
    htmlpop = "<b>" + row['ENDING_NODE'] +"<br/>" + str(row['DATE']) + "</b><br/><a href=" +row['URL'] + '" target="_blank">'+row['TITLE']+'</a><br/>'+row['DESCRIPTION']+'<br/><table style="border:1; width:100%"><tr><td style="background-color: lightgray;">Node Distance</td><td>' +\
